    ...
    <article>
        ...
        <form name="PostForm" action="" method="post" enctype="multipart/form-data">
            ...
            <label class="label">
                ...
                <input type="file" name="empresa_capa" value="<?php if (isset($data['empresa_capa'])) echo $data['empresa_capa']; ?>" />
            </label>
            ...
            <div class="label_line">
                <label class="label_medium">
                    ...
                    <input type="url" placeholder="http://www.require.com.br" name="empresa_site" value="<?php if (isset($data['empresa_site'])) echo $data['empresa_site']; ?>" />
                </label>

                <label class="label_medium">
                    <span class="field">Facebook Page:</span>
                    <input type="text" placeholder="RequireWeb" name="empresa_facebook" value="<?php if (isset($data['empresa_facebook'])) echo $data['empresa_facebook']; ?>" />
                </label>                
            </div><!-- line -->
            ...
            <div class="label_line">
                ...
                <label class="label_small">
                    ...
                    <select name="empresa_categoria">
                        ...
                        <option value="onde-se-divertir" <?php if (isset($data['empresa_categoria']) && $data['empresa_categoria'] == 'onde-se-divertira') echo 'selected'; ?>> Onde se divertir</option>

                        <option value="onde-se-embelezar" <?php if (isset($data['empresa_categoria']) && $data['empresa_categoria'] == 'onde-se-embelezar') echo 'selected'; ?>> Onde se embelezar</option>
