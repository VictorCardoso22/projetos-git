...
<div class="content list_content">
    ...
    <section>
        ...
        if ($empty):
            WSErro("Ops: Você tentou editar um post que não existe no sistema!", WS_ALERT);
        endif;
        ...
        if ($action):
            ...
            switch ($action) :
                ...
                case 'inative':
                    ...
                    WSErro("O status do post foi atualizado para <b>inativo</b>, o post agore é um racunho!", WS_ALERT);
                    break;
                ...
                default:
                    WSErro("Ação não foi identificada pelo sistema, favor utilize os botões!", WS_ALERT);
                    break;
            endswitch;
        ...
        if ($readPosts->getResult()):
            foreach ($readPosts->getResult() as $post):
                ...
                <article<?php if ($posti % 2 == 0) echo ' class="right"'; ?> <?= $status; ?>>
                    ...
                    <div class="img thumb_small">
                       ...
                       <img src='<?=HOME ?>/tim.php?src=<?=HOME ?>/uploads/<?=$post_cover ?>&w=120&h=70' />
                        
                    </div>
                    <h1><a target="_blank" href="../artigo/<?= $post_name; ?>" title="Ver Post"><?= Check::Words($post_title, 8) ?></a></h1>
            ...
            $Pager->ReturnPage();
            WSErro("Desculpe, ainda não exixtem posts cadastrados!", WS_INFOR);
        endif;
        ?>
