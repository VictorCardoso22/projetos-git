...
class Seo {
    ...
    private function getSeo() {
        ...
        switch ($this->File):
            ...
            case 'contato':
                $this->Data = [SITENAME . ' - Entre em contato conosco!', SITEDESC, HOME, INCLUDE_PATH . '/images/site.png'];
                break;
            //SEO:: INDEX
            case 'index':
                $this->Data = [SITENAME . ' - O melhor guia em Maceio-Al!', SITEDESC, HOME, INCLUDE_PATH . '/images/site.png'];
                break;
