 ...
 * Responsavel pelas estatisticas, sessões e atualizações de trafego do sistema!
...
class Session {
    ...
    //verifica e insre o trafego na tabela
    ...
    // obtem dados da tabele [KELPER TRAFFIC]
    //ws_siteviews
    ...
    //verifica, cria e atualiza cookie do usuartio
    private function getCookie() {
        $Cookie = filter_input(INPUT_COOKIE, 'useronline', FILTER_DEFAULT);
        setcookie('useronline', base64_encode("3mares"), time() + 86400);
        if (!$Cookie):
            return false;
        else:
            return true;
    ...
    //Cadastra usuÃ¡rio online na tabela!
    ...
    //Atualiza navegaÃ§Ã£o do usuÃ¡rio online!
