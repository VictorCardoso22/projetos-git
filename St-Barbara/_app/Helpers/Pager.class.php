...
class Pager {
    ...
    private function getSyntax() {
        ...
        if ($this->Rows > $this->Limit):
            ...
            $this->Paginator = "<ul class=\"pagination mrgt-0\">";
            $this->Paginator .= "<li><a title=\"{$this->First}\" href=\"{$this->Link}1\">&laquo;</a></li>";
            ...
            $this->Paginator .= "<li class=\"active\"><span>{$this->Page}</span></li>";
            ...
            $this->Paginator .= "<li><a title=\"{$this->Last}\" href=\"{$this->Link}{$Paginas}\">&raquo;</a></li>";
            $this->Paginator .= "</ul>";
        endif;
    }
